...
async fetchFmpFundHistory(symbol, range) {
            ...
            async fetchAlphaVantageFundData(symbol) {
                ...
                try {
                    ...
                    const changePercent = parseFloat(String(percentRaw).replace('%', '')) or (previousClose ? (change / previousClose) * 100 : 0);
